        ...
        <div class="container">
			...
			// Loop the employee data
				...
				while($row = $result->fetch_object()){
					echo '<tr>'.'<th width="100" scope="col">Participant Name</th>'
						.'<td width="283">'.$row->participant_name.'</td>'.'</tr>'
                        .'<tr>'.'<th width="100" scope="col">Date of birth</th>'
						.'<td width="283">'.$row->participant_dob.'</td>'.'</tr>'
                        .'<tr>'.'<th width="100" scope="col">Email</th>'
						.'<td width="283">'.$row->participant_email.'</td>'.'</tr>'
